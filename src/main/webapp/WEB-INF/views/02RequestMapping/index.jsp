...
<br /><br /><hr />
		...
		$(function(){
			...
			//문서 내 input태그 중 type이 button인 엘리먼트를 클릭했을 때 실행
			$('input[type=button]').click(function() {
				...
				if(!f.searchWord.value){
					...
					if($(this).attr('id')=='btnGet'){
						console.log("난 GET");
						//검색폼의 method속성에 get을 추가한 후 submit(전송)한다.
		...
		<!-- form태그 작성시 method속성은 따로 부여하지 않고 jQuery에서 부여한다. 
		그 외 속성도 동일하게 처리할 수 있다.-->
